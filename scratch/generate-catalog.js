...
export const PRODUCTS_CATALOG: ProductCatalogItem[] = [
  ...
  {
    id: "lanyards-china-hook",
    slug: "lanyards-china-hook",
    name: "20mm Polyester Lanyards (China Hook)",
    category: "Corporate Identity",
    basePrice: 55.00,
    description: "Professionally printed ID lanyards with standard Metal China Hook. High-quality polyester material with vibrant sublimation printing.",
    moq: 39,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.7,
    reviewCount: 88,
  ...
  {
    id: "lanyards-overlock-hook",
    slug: "lanyards-overlock-hook",
    name: "20mm Polyester Lanyards (Overlock Hook)",
    category: "Corporate Identity",
    basePrice: 58.00,
    description: "Professionally printed ID lanyards with Overlock Hook (Stronger Reinforced Finish). Ideal for long-term daily wear.",
    moq: 39,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 52,
    customizerType: "standard-tiers",
    priceTiers: [
      { min: 39, max: 99, price: 58.00 },
      { min: 100, max: 149, price: 51.00 },
      { min: 150, max: 199, price: 47.00 },
      { min: 200, max: 249, price: 43.00 },
      { min: 250, max: 299, price: 39.00 },
      { min: 300, max: 399, price: 35.00 },
      { min: 400, max: 499, price: 31.00 },
      { min: 500, max: 999999, price: 28.00 }
    ]
  },
  {
    id: "lanyards-double-hook",
    slug: "lanyards-double-hook",
    name: "20mm Polyester Lanyards (Double China Hook)",
    category: "Corporate Identity",
    basePrice: 58.00,
    description: "Professionally printed ID lanyards with Dual Metal China Hooks. Best for multi-card usage, access cards, and events.",
    moq: 39,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 30,
  ...
  {
    id: "lanyards-safety-breakaway",
    slug: "lanyards-safety-breakaway",
    name: "20mm Polyester Lanyards (Safety Breakaway)",
    category: "Corporate Identity",
    basePrice: 60.00,
    description: "Professionally printed ID lanyards with China Hook + Plastic Safety Breakaway Clip. Prevents choking or pulling hazards.",
    moq: 39,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.9,
    reviewCount: 45,
    customizerType: "standard-tiers",
    priceTiers: [
      { min: 39, max: 99, price: 60.00 },
      { min: 100, max: 149, price: 50.00 },
      { min: 150, max: 199, price: 46.00 },
      { min: 200, max: 249, price: 42.00 },
      { min: 250, max: 299, price: 38.00 },
      { min: 300, max: 399, price: 34.00 },
      { min: 400, max: 499, price: 30.00 },
      { min: 500, max: 999999, price: 27.00 }
    ]
  },
  {
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "Custom-designed apparel and uniforms including T-Shirts, Hoodies, Jackets & Jerseys. Multiple fabric options, Sublimation, Screen Printing, and Embroidery.",
    moq: 10,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 112,
...
console.log('Successfully generated products-catalog.ts');
