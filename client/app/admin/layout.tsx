...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#0A0A0C] text-zinc-100 font-sans antialiased relative overflow-x-hidden selection:bg-[#FF5E36]/30 selection:text-white flex flex-col">
      {/* Ambient glows */}
