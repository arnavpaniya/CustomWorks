...
import { User, Package, Heart, Bookmark, LogOut, ChevronRight } from "lucide-react";
import { Badge } from "@/components/ui/badge";

const MOCK_ORDERS = [
  { id: "CW-20240101", date: "12 Jan 2025", total: 1498, status: "DELIVERED", items: 2 },
  { id: "CW-20240202", date: "2 Feb 2025", total: 899, status: "DISPATCHED", items: 1 },
  { id: "CW-20240315", date: "15 Mar 2025", total: 2197, status: "PROCESSING", items: 3 },
];
        ...
        <div className="md:col-span-1">
          <div className="bg-white rounded-2xl border border-brand-border overflow-hidden shadow-md">
            <div className="p-5 border-b border-brand-border bg-brand-surface text-brand-black">
              ...
              <p className="font-bold">Arnav Paniya</p>
              <p className="text-brand-muted text-sm">arnavpaniya@gmail.com</p>
            </div>
            <nav>
              {[
              ...
              <button className="flex items-center gap-2.5 w-full px-5 py-3.5 text-sm font-medium text-red-500 hover:bg-red-50 transition-colors">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-brand-border p-6 shadow-md">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="text-sm text-black font-medium underline underline-offset-4 hover:opacity-85">Edit</button>
            </div>
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              {[
                { label: "Full Name", value: "Arnav Paniya" },
                { label: "Email", value: "arnavpaniya@gmail.com" },
          ...
          <div className="bg-white rounded-2xl border border-brand-border p-6 shadow-md">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/account/orders" className="text-sm text-black font-medium underline underline-offset-4 hover:opacity-85">View all</Link>
            </div>
