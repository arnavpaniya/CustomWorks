...
export const PRODUCTS_CATALOG: ProductCatalogItem[] = [
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "Premium Bi-Fold brochures designed for detailed corporate presentations, menus, and product catalogs. Printed on high-quality 130GSM/170GSM art paper with precise folding.",
    moq: 500,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 42,
  ...
  },
  {
    ...
    name: "Tri-Fold Brochures (6 Pages)",
    category: "Marketing & Promotions",
    basePrice: 0,
    isQuoteOnly: true,
    description: "Classic Tri-Fold brochures perfect for handouts, mailers, and detailed informational guides. Printed on high-quality 130GSM/170GSM art paper with precise folding.",
    moq: 500,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.9,
    reviewCount: 56,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "High-quality custom stickers and labels in various shapes, sizes, and finishes (matte, glossy, clear). Ideal for product packaging, branding, and promotional giveaways.",
    moq: 100,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 45,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "Premium hang tags and clothing tags for retail apparel and products. Available in various card stocks, shapes, and premium finishes including foil stamping and spot UV.",
    moq: 100,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.9,
    reviewCount: 32,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "High-quality ceramic mugs featuring vibrant custom printing. Perfect for corporate gifting, office use, and promotional merchandise.",
    moq: 10,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.9,
    reviewCount: 88,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "High-impact roll-up standees ideal for events, exhibitions, and retail displays. Available in standard 6x3ft and 6x2.5ft sizes with durable aluminum frames.",
    moq: 1,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 120,
  ...
  },
  {
    id: "badges",
    slug: "badges",
    name: "Custom Button Badges",
    category: "Marketing & Promotions",
    basePrice: 0,
    isQuoteOnly: true,
    description: "Custom printed button badges (pin-back) for promotional campaigns, events, and brand awareness. Available in multiple sizes (e.g., 44mm, 58mm).",
    moq: 100,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.7,
    reviewCount: 65,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "Eye-catching ceiling danglers for retail store promotions and event branding. Printed on rigid sunboard or thick cardstock, cut to custom shapes.",
    moq: 50,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.9,
    reviewCount: 22,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "Custom printed duplicate or triplicate invoice books. Each A4 book contains 50 sets with sequential numbering and perforated sheets.",
    moq: 10,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 41,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "Custom duplicate receipt books for cash and transaction tracking. Numbered and perforated for easy tear-off.",
    moq: 10,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.7,
    reviewCount: 15,
  ...
  },
  {
    id: "register-books",
    slug: "register-books",
    name: "Register Books (A4 Hardbound)",
    category: "Office & Speciality Printing",
    basePrice: 0,
    isQuoteOnly: true,
    description: "Hardbound A4 register books with 100 pages. Custom printed columns and headers for specialized record keeping.",
    moq: 10,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.9,
    reviewCount: 12,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "Custom printed office labels for files, folders, and inventory management. Available in sheets or rolls.",
    moq: 10,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.8,
    reviewCount: 28,
  ...
  },
  {
    ...
    basePrice: 0,
    isQuoteOnly: true,
    description: "High-quality custom printed certificates on 300 GSM premium textured or matte paper. Ideal for awards and recognition.",
    moq: 10,
    images: ["/images/placeholder-product.jpg"],
    rating: 4.9,
    reviewCount: 55,
